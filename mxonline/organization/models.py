...
class CourseOrg(models.Model):
    ...
    tag = models.CharField(max_length=10,verbose_name=u"机构标签",default="全国名校")
...
class Teacher(models.Model):
    ...
    click_nums = models.IntegerField(default=0,verbose_name=u"点击数")
    age = models.IntegerField(default=0, verbose_name=u"工作年限")
    fav_nums = models.IntegerField(default=18, verbose_name=u"年龄")
    add_time = models.DateTimeField(default=datetime.now)
    image = models.ImageField(upload_to='teacher/%Y/%m', verbose_name=u"头像",default=u'image/default.png')
